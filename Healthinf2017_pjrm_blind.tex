...
\author{\authorname{(omitted for review process)\sup{1}, (omitted for review process)\sup{1}}
\affiliation{\sup{1}(omitted for review process)}
\affiliation{}
\email{(omitted for review process)}
}
