...
The ANT protocol is popular because of its low energy consumption and existence of suitable means for body parameters description. The main benefit are 'device profiles' (called ANT+) that define sending data over the network in a consistent way~\cite{innovations2013ant}. Profiles facilitate development of sensors and management of sensor data in application programs.
